        ...
        if also_floor_or_brochure is not None:
            ...
            if field == "Floor Plan":
                if record.get("Brochure PDF") != also_floor_or_brochure:
                    local_failures.append(
                        f"{record['Building']!r} ({record['Floor/Unit']}): expected Brochure PDF {also_floor_or_brochure!r} "
                        f"(floor-plan dual-fill), got {record.get('Brochure PDF')!r}"
                    )
            elif record.get("Floor Plan") != also_floor_or_brochure:
                local_failures.append(
                    f"{record['Building']!r} ({record['Floor/Unit']}): expected Floor Plan seed "
                    f"{also_floor_or_brochure!r}, got {record.get('Floor Plan')!r}"
                )
